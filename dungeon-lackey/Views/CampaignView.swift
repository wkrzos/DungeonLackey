...
struct CampaignView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Are you sure you want to delete this campaign?", isPresented: $showDeleteConfirmation, titleVisibility: .visible) {
...
#Preview {
    CampaignView(campaign: Campaign(title: "a", backgroundPicture: "b", nextSession: Date()))
}
